...
converts a structured description of an urban site and one proposed
nature-based intervention into comparable scores and indicative quantitative
estimates, so that early planning and investment decisions can be made on a
transparent, evidence-referenced basis.

A user describes a site through six input groups, selects one of fourteen
intervention typologies, and receives a Heat Priority Index, a Cooling
...
Interventions for the same site can be assessed and compared side by side.
...
would look more decisive and would be easier to put in a slide. The adopted
cooling envelopes span factors of two to six, and the climate-subzone estimates
in \textcite{keravec2026} carry uncertainty intervals ranging from about
$\pm\,$\qty{0.6}{\degreeCelsius} to about $\pm\,$\qty{2.0}{\degreeCelsius}; a
point estimate would imply a
