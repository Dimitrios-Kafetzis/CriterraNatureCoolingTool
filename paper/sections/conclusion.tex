...
\num{0.15}. The sensitivity analysis specified in \Cref{sec:sensitivity} is a
commitment whose results do not yet exist, and several sub-indicator derivation
rules remain unspecified at this version.

The methodology is offered for review in that condition rather than after its
gaps have been closed, because the values most in need of scrutiny are settled
most cheaply before an engine, a user base, and a set of published assessments
have accumulated around them. The tool, its complete configuration, and this
