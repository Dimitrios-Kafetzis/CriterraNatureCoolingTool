...
\Cref{tab:app-entries} lists the \num{110} catalogue entries and the archetype
...
\subsection{The \texorpdfstring{\num{110}}{110} catalogue entries and the
...
\caption[The 110 catalogue entries]{The \num{110} curated catalogue entries,
...
\addlinespace
\multicolumn{4}{@{}l}{\textit{Water landscape} (12)}\\
...
\addlinespace
\multicolumn{4}{@{}l}{\textit{Building} (3)}\\
