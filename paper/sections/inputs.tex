...
\Cref{app:fields} marks as required only the four that a documented formula
cannot be evaluated without, since the definitive split is fixed by the input
schema and that schema does not yet exist. Reducing the total count
