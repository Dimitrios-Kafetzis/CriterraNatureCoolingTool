...
scores are fixed at version \methver{} in
...
(\texttt{nature\_cooling.engine.models.AssessmentInput}). Fields marked
...
\Cref{eq:heat-exposure-rich}; declared in configuration at version
\methver{}. \\
...
Urban-context suitability sub-indicator: in the typology's typical-use
contexts 100, outside 25, unknown 50 (\Cref{tab:suitability-rules}).
\emph{campus} and \emph{memorial} added at version \methver{}, with the
affected typology context lists extended in the same change so that neither
new setting scores out-of-context by construction. \\
\addlinespace
...
one confidence slot. New at version \methver{}. \\
...
Standard levels; equity sub-indicator. New at version \methver{}. \\
...
Validation warning when exceeding the site area (OQ-04); enters no score. \\
...
$C_{\mathrm{capital}}$ in \Cref{eq:payback}. Absent: capital cost, payback,
cost feasibility, and investment readiness all \emph{not estimated}. \\
