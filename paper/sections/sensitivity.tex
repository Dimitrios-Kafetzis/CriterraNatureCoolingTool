...
The results are \textbf{regenerated for this version, not carried forward}. At
version \prevver{} they were re-confirmed unchanged because no library value
had moved; that is not true here. The library moved from fourteen typologies to
\num{110} entries over \num{18} archetypes and the scenario set grew from
twenty to \num{24}, so the analysis was re-executed in full. The aggregation
weights themselves are \textbf{unchanged}: what moved is the population of
scenarios they are applied to.
\end{keynote}
...
\subsection{What moved since version \prevver{}, and why}
\label{sec:sa-moved}

\begin{keynote}
\noindent\textbf{Every headline figure is slightly worse than at version
\prevver{}, and the honest reading is that this is a property of the scenario
set rather than a degradation of the methodology.}

\begin{center}\small
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{Headline figure} & \textbf{\prevver{}} & \textbf{\methver{}} \\
\midrule
Worst-case rank stability      & 0.9737   & 0.9529 \\
Pooled mean displacement       & 0.42     & 0.47 \\
Category migrations            & 3 of 240 & 8 of 288 \\
...
The four new scenarios were chosen to exercise this release's \emph{evidence}
edge cases --- the small-water envelope, the pergola-scale ceiling, the package
cap, and the productive evidence gap --- and not to sit comfortably inside
