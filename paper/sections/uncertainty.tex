...
The adopted cooling envelopes of \Cref{tab:typologies} span factors of three to
ten: the narrowest are threefold (urban forest, blue-green corridor, riparian
restoration, and the mixed package, each \SIrange{1.0}{3.0}{\degreeCelsius}),
while green roof at \SIrange{0.1}{1.0}{\degreeCelsius} is tenfold and rain
garden / bioswale at \SIrange{0.1}{0.8}{\degreeCelsius} is eightfold. The
...
\texttt{config/derived\_scores.yaml} (fixed at version \methver{}, decision
