...
The golden-scenario set will be the same collection of hand-verified
input/output cases specified as the engine's regression suite
(\Cref{sec:testing}), so that the scenarios exercised by the sensitivity
